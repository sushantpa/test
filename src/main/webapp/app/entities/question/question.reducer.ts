...
export const ACTION_TYPES = {
  ...
  PARTIAL_UPDATE_QUESTION: 'question/PARTIAL_UPDATE_QUESTION',
...
export default (state: QuestionState = initialState, action): QuestionState => {
  switch (action.type) {
    ...
    case REQUEST(ACTION_TYPES.PARTIAL_UPDATE_QUESTION):
      return {
        ...state,
        errorMessage: null,
        updateSuccess: false,
    ...
    case FAILURE(ACTION_TYPES.PARTIAL_UPDATE_QUESTION):
    ...
    case SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_QUESTION):
      return {
        ...state,
        updating: false,
        updateSuccess: true,
...
export const partialUpdate: ICrudPutAction<IQuestion> = entity => async dispatch => {
  const result = await dispatch({
    type: ACTION_TYPES.PARTIAL_UPDATE_QUESTION,
