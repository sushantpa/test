...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8081';
    'jhipster.clientApp.name' = 'assessment';
    ...
    'jhipster.mail.from' = 'assessment@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'assessment API';
    'jhipster.swagger.description' = 'assessment API documentation';
    ...
    'eureka.instance.appname' = 'assessment';
    'eureka.instance.instanceId' = 'assessment:${random.value}';
