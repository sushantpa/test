...
describe('User', () => {
    ...
    it('/POST create user', async () => {
        const createdUser: UserDTO = (await request(app.getHttpServer())
    ...
    it('/PUT update user', async () => {
        ...
        const updatedUser: UserDTO = (await request(app.getHttpServer())
            .put('/api/admin/users')
            .send(savedUser)
            .expect(200)).body;
    ...
    it('/GET user with a login name', async () => {
        ...
        const getUser: UserDTO = (await request(app.getHttpServer())
